...
public class ChatMessage
{
    ...
    public ChatMessage(Guid conversationId, Guid jobId, Guid senderId, string content)
    {
    ...
    public static ChatMessage FromPersistence(string id, Guid conversationId, Guid jobId, Guid senderId, string content, DateTime sentAt)
    {
